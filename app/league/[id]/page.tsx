...
export default async function LeaguePage({
  ...
  const leagueConfig = league.configJson as { features?: string[] } | null;
  const hasMatchScores = leagueConfig?.features?.includes("match_scores") ?? false;
  ...
  if (hasMatchScores) {
    ...
    // No match_scores feature — fetch manual Top 3 picks and team list
